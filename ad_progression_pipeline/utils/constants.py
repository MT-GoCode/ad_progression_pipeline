...
ord_gds_feats = [
    ...
    "ENERGY",
    "HOPELESS",
    "BETTER",  # recode 9 as -1, -4 = NaN - ordinal
    "NACCGDS",
]  # 88 or -4 = NaN - ordinal
ord_faq_feats = [
    "BILLS",
    ...
    "REMDATES",
    "TRAVEL",
]  # recode 8 as -1, 9 or -4 = NaN
# Decide to drop the binary variables in NPI
ord_npi_feats = ["DELSEV", "HALLSEV", "AGITSEV", "DEPDSEV", "ANXSEV", "ELATSEV", "APASEV", "DISNSEV", "IRRSEV", "MOTSEV", "NITESEV", "APPSEV"]
...
num_np_feats = ["NACCMMSE", "MEMUNITS", "DIGIF", "DIGIFLEN", "DIGIB", "DIGIBLEN", "ANIMALS", "VEG", "BOSTON", "TRAILA", "TRAILB"]
ORDINAL_FEATURES = list(
    ord_demo_feats + ord_phist_feats + ord_fhist_feats + ord_phys_feats + ord_npi_feats + ord_gds_feats + ord_faq_feats + ord_np_feats,
)
